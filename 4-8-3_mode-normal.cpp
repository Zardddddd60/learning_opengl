...
int main()
{
    ...
    Shader modelShader("res/shaders/normal_model/model.vs", "res/shaders/normal_model/model.fs");
    Shader normalShader("res/shaders/normal_model/normal.vs", "res/shaders/normal_model/normal.fs", "res/shaders/normal_model/normal.gs");
